...
void rst::rasterizer::rasterize_triangle(const Triangle& t, const std::array<Eigen::Vector3f, 3>& view_pos) 
{
    ...
    int x_min = min(t.v[0].x(), min(t.v[1].x(), t.v[2].x()));
    int x_max = max(t.v[0].x(), max(t.v[1].x(), t.v[2].x()));
    int y_min = min(t.v[0].y(), min(t.v[1].y(), t.v[2].y()));
    int y_max = max(t.v[0].y(), max(t.v[1].y(), t.v[2].y()));
